            ...
            <div class="main-bar bg-white">
                <div class="container">
                    <div class="logo-header">
                        <a href="{{'en'}}">
                            <img src="{{url('frontend/en/images/logo-dark-1.png')}}" width="230" height="67" alt="" />
                        </a>
                    </div>
                    <!-- NAV Toggle Button -->
                                    ...
                                    <div class="nav-cart-items p-a15">
                                        <div class="nav-cart-item clearfix">
                                            <div class="nav-cart-item-image">
                                                <a href="#"><img src="{{url('frontend/en/images/cart/pic-1.jpg')}}" alt="p-1"></a>
                                            </div>
                                        ...
                                        <div class="nav-cart-item clearfix">
                                            <div class="nav-cart-item-image">
                                                <a href="#"><img src="{{url('frontend/en/images/cart/pic-2.jpg')}}" alt="p-2"></a>
                                            </div>
                                            <div class="nav-cart-item-desc">
                                        ...
                                        <div class="nav-cart-item clearfix">
                                            <div class="nav-cart-item-image">
                                                <a href="#"><img src="{{url('frontend/en/images/cart/pic-3.jpg')}}" alt="p-1"></a>
                                            </div>
                                            <div class="nav-cart-item-desc">
                                                <a href="#">Safety helmet</a>
                                                <span class="nav-cart-item-price"><strong>2</strong> x $19.99</span>
                                        ...
                                        <div class="nav-cart-item clearfix">
                                            <div class="nav-cart-item-image">
                                                <a href="#"><img src="{{url('frontend/en/images/cart/pic-4.jpg')}}" alt="p-2"></a>
                                            </div>
                                            <div class="nav-cart-item-desc">
                                                <a href="#">Hammer drill machine</a>
                                                <span class="nav-cart-item-price"><strong>1</strong> x $24.99</span>
